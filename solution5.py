...
images = []
measurements = []
for aug_image, aug_measurement in zip(aug_images,aug_measurements):
	name = aug_image
...
print("images+flipped images",len(images))
	
			
from sklearn.model_selection import train_test_split

train_samples, validation_samples, train_angles, valid_angles = train_test_split(images, measurements, test_size=0.2)
	
def generator(gen_images,gen_measurements,batch_size):
...
train_generator = generator(train_samples,train_angles, batch_size=32)
validation_generator = generator(validation_samples,valid_angles, batch_size=32)
